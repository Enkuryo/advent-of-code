...
describe('Year 2024 - Day 16', () => {
  ...
  test('Part 2 - Example Input returns 45', () => {
    expect(partTwo(EXAMPLE_INPUT)).toBe(45);
  });
  test('Part 2 - Second Example Input returns 64', () => {
    expect(partTwo(SECOND_EXAMPLE)).toBe(64);
  });
});
